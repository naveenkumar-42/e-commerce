...
productData.map(function(elem) {
  ...
  // Add an onclick event to redirect to the product details page
  img.onclick = function() {
    displayProductDetails(elem);
  };
...
// You may implement the logic to display product details using the passed product object
// For example, redirect to a product details page with the product data
const productIdParam = encodeURIComponent(product.id);
window.location.href = `productDetails.html?id=${productIdParam}`;
}
